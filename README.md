# Для корректной работы проекта нужно запустить сначала backend --> (https://github.com/e-doschechnikova/Product-Table-back), а потом запустить сам проект --> `yarn start`
